...
SecretKeeper is a zero-knowledge, one-time secret sharing platform built with security as the primary focus. Share sensitive information securely with automatic expiration and client-side encryption.
...
Try SecretKeeper at [https://secretkeeper.example.com](https://secretkeeper.example.com)
...
- GitHub Issues: [https://github.com/yourcompany/secretkeeper/issues](https://github.com/yourcompany/secretkeeper/issues)
